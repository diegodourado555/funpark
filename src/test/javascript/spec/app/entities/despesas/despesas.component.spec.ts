...
import { DespesasComponent } from 'app/entities/despesas/despesas.component';
...
describe('Component Tests', () => {
  describe('Despesas Management Component', () => {
    let comp: DespesasComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DespesasComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.despesas && comp.despesas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
