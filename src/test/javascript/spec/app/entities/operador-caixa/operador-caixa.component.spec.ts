...
import { OperadorCaixaComponent } from 'app/entities/operador-caixa/operador-caixa.component';
...
describe('Component Tests', () => {
  describe('OperadorCaixa Management Component', () => {
    let comp: OperadorCaixaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [OperadorCaixaComponent],
        providers: [
          {
        ...
        .overrideTemplate(OperadorCaixaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.operadorCaixas && comp.operadorCaixas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
