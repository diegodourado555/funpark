...
import { ReceitasComponent } from 'app/entities/receitas/receitas.component';
...
describe('Component Tests', () => {
  describe('Receitas Management Component', () => {
    let comp: ReceitasComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ReceitasComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.receitas && comp.receitas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
