...
import { MenuPerfilComponent } from 'app/entities/menu-perfil/menu-perfil.component';
...
describe('Component Tests', () => {
  describe('MenuPerfil Management Component', () => {
    let comp: MenuPerfilComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MenuPerfilComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.menuPerfils[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
