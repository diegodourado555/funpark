...
import br.com.repository.MenuRepository;
import br.com.service.MenuService;
import br.com.service.dto.MenuDTO;
import br.com.service.mapper.MenuMapper;
...
public class MenuResourceIT {
    ...
    public void createMenu() throws Exception {
        ...
        assertThat(testMenu.getDescricao()).isEqualTo(DEFAULT_DESCRICAO);
    }
    ...
    public void updateMenu() throws Exception {
        ...
        Menu testMenu = menuList.get(menuList.size() - 1);
        assertThat(testMenu.getDescricao()).isEqualTo(UPDATED_DESCRICAO);
    }
