...
public interface ContaCorrenteRepository extends JpaRepository<ContaCorrente, Long> {
	...
	@Query(value = "SELECT new br.com.service.dto.ContaCorrenteDTO(cc.id, cc.valor, cc.data, cc.metodoPagamento, r.id, r.descricao, d.id, d.descricao, op.id, op.nome, l.id, l.nomeFantasia) "
