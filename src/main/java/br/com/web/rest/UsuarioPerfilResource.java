...
/**
 * REST controller for managing {@link br.com.domain.UsuarioPerfil}.
 */
@RestController
@RequestMapping("/api")
public class UsuarioPerfilResource {
    ...
    public ResponseEntity<UsuarioPerfilDTO> createUsuarioPerfil(@RequestBody UsuarioPerfilDTO usuarioPerfilDTO) throws URISyntaxException {
    ...
    public ResponseEntity<UsuarioPerfilDTO> updateUsuarioPerfil(@RequestBody UsuarioPerfilDTO usuarioPerfilDTO) throws URISyntaxException {
